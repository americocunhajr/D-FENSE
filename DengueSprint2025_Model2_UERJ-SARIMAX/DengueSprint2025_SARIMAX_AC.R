...
DengueSprint2025_AggregatedData_AC <- read.csv("DengueSprint2025_AggregatedData_AC.csv")
DengueSprint2025_AggregatedData_AC$ln100_casos <- log(DengueSprint2025_AggregatedData_AC$cases+100)
DengueSprint2025_AggregatedData_AC_ts <- ts(DengueSprint2025_AggregatedData_AC,
                                            start = c(2010,1),
                                            frequency = 52)
plot(DengueSprint2025_AggregatedData_AC_ts[,"ln100_casos"])



# Modelo diferença sazonal para o período T3

plot(window(DengueSprint2025_AggregatedData_AC_ts[,"ln100_casos"],
            start=c(2010,52),
            end = c(2021,25)))

(m1 <- auto.arima(window(DengueSprint2025_AggregatedData_AC_ts[,"ln100_casos"],
                         start=c(2011,02),
                         end = c(2024,25)),
                  xreg = cbind(window(DengueSprint2025_AggregatedData_AC_ts[,"temp_med"],
                                      start=c(2010,52),
                                end = c(2024,23)),
                               ts(rollsumr(DengueSprint2025_AggregatedData_AC_ts[,"precip_med"],k=52)/52,
                                  start=c(2010,52),
                                  end = c(2024,23),
                                  freq=52))))
...
(M1 <- TSA::arima(window(DengueSprint2025_AggregatedData_AC_ts[,"ln100_casos"],,
                         start=c(2011,02),
                         end = c(2024,25)),
                  order = c(1,0,1)
...
for_M1 <- predict(M1, n.ahead=67
                  ,newxreg=cbind(window(DengueSprint2025_AggregatedData_AC_ts[,"temp_med"],
                                        start=c(2023,24),
                                        end = c(2024,38)),
                                 ts(rollsumr(DengueSprint2025_AggregatedData_AC_ts[,"precip_med"],k=52)/52,
                                    start=c(2023,24),
...
data <- window(DengueSprint2025_AggregatedData_AC_ts[,"epiweek"],
               start=c(2023,26),
               end=c(2024,40))+100
...
(M1 <- TSA::arima(window(DengueSprint2025_AggregatedData_AC_ts[,"ln100_casos"],,
                  ...
                  order = c(2,0,1)
                  , seasonal = list(order = c(0,0,1))#,io=out_m1$ind
                  ,xreg = cbind(window(DengueSprint2025_AggregatedData_AC_ts[,"temp_med"],
                                       start=c(2010,52),
                                       end = c(2022,23)),
                                ts(rollsumr(DengueSprint2025_AggregatedData_AC_ts[,"precip_med"],k=52)/52,
...
(M1 <- TSA::arima(window(DengueSprint2025_AggregatedData_AC_ts[,"ln100_casos"],,
                  ...
                  order = c(2,0,1)
                  , seasonal = list(order = c(0,0, 0))#,io=out_m1$ind
                  ,xreg = cbind(window(DengueSprint2025_AggregatedData_AC_ts[,"temp_med"],
                                       start=c(2010,52),
                                       end = c(2023,23)),
                                ts(rollsumr(DengueSprint2025_AggregatedData_AC_ts[,"precip_med"],k=52)/52,
