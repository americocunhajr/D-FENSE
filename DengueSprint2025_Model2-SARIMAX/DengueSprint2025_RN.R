...
DengueSprint2025_AggregatedData_RN <- read.csv("DengueSprint2025_AggregatedData_RN.csv")
DengueSprint2025_AggregatedData_RN$ln100_casos <- log(DengueSprint2025_AggregatedData_RN$cases+100)
DengueSprint2025_AggregatedData_RN_ts <- ts(DengueSprint2025_AggregatedData_RN,
                                            start = c(2010,1),
                                            frequency = 52)
plot(DengueSprint2025_AggregatedData_RN_ts[,"ln100_casos"])



# Modelo diferença sazonal para o período T1

plot(window(DengueSprint2025_AggregatedData_RN_ts[,"ln100_casos"],
            start=c(2010,52),
            end = c(2021,25)))

(m1 <- auto.arima(window(DengueSprint2025_AggregatedData_RN_ts[,"ln100_casos"],
                         start=c(2011,02),
                         end = c(2021,25)),
                  xreg = cbind(window(DengueSprint2025_AggregatedData_RN_ts[,"temp_med"],
                                      start=c(2010,52),
                                end = c(2021,23)),
                               ts(rollsumr(DengueSprint2025_AggregatedData_RN_ts[,"precip_med"],k=52)/52,
                                  start=c(2010,52),
                                  end = c(2021,23),
                                  freq=52))))
...
(M1 <- TSA::arima(window(DengueSprint2025_AggregatedData_RN_ts[,"ln100_casos"],,
                         start=c(2011,02),
                         end = c(2021,25)),
                  order = c(1,0,1)
...
for_M1 <- predict(M1, n.ahead=67
                  ,newxreg=cbind(window(DengueSprint2025_AggregatedData_RN_ts[,"temp_med"],
                                        start=c(2021,24),
                                        end = c(2022,38)),
                                 ts(rollsumr(DengueSprint2025_AggregatedData_RN_ts[,"precip_med"],k=52)/52,
                                    start=c(2021,24),
...
data <- window(DengueSprint2025_AggregatedData_RN_ts[,"epiweek"],
               start=c(2021,26),
               end=c(2022,40))
