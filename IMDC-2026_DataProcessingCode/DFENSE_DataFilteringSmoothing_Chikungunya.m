...
%  with surveillance and climate variables
% -----------------------------------------------------------------
...
FileNameCSV  = 'IMDC2026_ProcessedData-Chikungunya_';
...
for j = 1:Nufs
    ...
    InputFileName = ['IMDC2026_AggregatedData-Chikungunya_',current_uf,'.csv'];
    ...
    SmoothedData(:, 1) = spline(time1,ProcessedData(:, 3),time2)';
    SmoothedData(:, 2) = spline(time1,ProcessedData(:, 4),time2)';
    SmoothedData(:, 3) = spline(time1,ProcessedData(:, 5),time2)';
    SmoothedData(:, 4) = spline(time1,ProcessedData(:, 6),time2)';
    SmoothedData(:, 5) = spline(time1,ProcessedData(:, 7),time2)';
    SmoothedData(:, 6) = spline(time1,ProcessedData(:, 8),time2)';
    SmoothedData(:, 7) = spline(time1,ProcessedData(:, 9),time2)';
    SmoothedData(:, 8) = spline(time1,ProcessedData(:,10),time2)';
    SmoothedData(:, 9) = spline(time1,ProcessedData(:,11),time2)';
    SmoothedData(:,10) = spline(time1,ProcessedData(:,12),time2)';
    SmoothedData(:,11) = spline(time1,ProcessedData(:,13),time2)';
    SmoothedData(:,12) = spline(time1,ProcessedData(:,14),time2)';
    SmoothedData(:,13) = spline(time1,ProcessedData(:,15),time2)';
    SmoothedData(:,14) = spline(time1,ProcessedData(:,16),time2)';
    SmoothedData(:,15) = spline(time1,ProcessedData(:,17),time2)';
    
    ProcessedData(:, 3) = SmoothedData(1:2:end, 1);
    ProcessedData(:, 4) = SmoothedData(1:2:end, 2);
    ProcessedData(:, 5) = SmoothedData(1:2:end, 3);
    ProcessedData(:, 6) = SmoothedData(1:2:end, 4);
    ProcessedData(:, 7) = SmoothedData(1:2:end, 5);
    ProcessedData(:, 8) = SmoothedData(1:2:end, 6);
    ProcessedData(:, 9) = SmoothedData(1:2:end, 7);
    ProcessedData(:,10) = SmoothedData(1:2:end, 8);
    ProcessedData(:,11) = SmoothedData(1:2:end, 9);
    ProcessedData(:,12) = SmoothedData(1:2:end,10);
    ProcessedData(:,13) = SmoothedData(1:2:end,11);
    ProcessedData(:,14) = SmoothedData(1:2:end,12);
    ProcessedData(:,15) = SmoothedData(1:2:end,13);
    ProcessedData(:,16) = SmoothedData(1:2:end,14);
    ProcessedData(:,17) = SmoothedData(1:2:end,15);

    % Round reported cases to an integer value
    ProcessedData(:, 3) = round(ProcessedData(:, 3));
    ...
    graphobj1.print     = 'yes';
    graphobj1.close     = 'no';
    Fig1 = PlotCurve1(epi_dates,ProcessedData(:,3)/1000,graphobj1);
    % ..........................................................
    ...
    graphobj2.print      = 'yes';
    graphobj2.close      = 'no';
    Fig2 = PlotEnvelope1(epi_dates,ProcessedData(:,4),...
                                   ProcessedData(:,5),...
                                   ProcessedData(:,6),graphobj2);
    % ..........................................................
    ...
    graphobj3.print        = 'yes';
    graphobj3.close        = 'no';
    Fig3 = PlotEnvelope1(epi_dates,ProcessedData(:,7),...
                                   ProcessedData(:,8),...
