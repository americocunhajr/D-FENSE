...
PositiveFields1 = {'epiweek',...
                   'casos',...
                   'geocode',...
                   'uf_code',...
                   'macroregional_geocode',...
                   'regional_geocode'};
PositiveFields2 = {'epiweek',...
                   'geocode',...
                   'precip_min',...
                   'precip_med',...
                   'precip_max',...
...
% Cleaning the raw data tables (eliminate spurious entries)
...
FederativeUnitsNames = unique(string(DATASET1.uf));
...
FileNameCSV  = 'IMDC2026_AggregatedData-Dengue_';
...
for j = 1:Nufs
    ...
    % Extract unique federative unit code
    unique_ufCode = unique(string(RawData1.uf_code));
    ...
    for i = 1:Nepiweeks
        ...
        % Aggregate the corresponding data
        AggregatedData(i, 1) = unique_epiweeks1(i);
        AggregatedData(i, 2) = unique_ufCode;
        AggregatedData(i, 3) =  sum(SelectedData1(current_indices1, 2));
        AggregatedData(i, 4) = mean(SelectedData2(current_indices2, 2));
        AggregatedData(i, 5) = mean(SelectedData2(current_indices2, 3));
        AggregatedData(i, 6) = mean(SelectedData2(current_indices2, 4));
        AggregatedData(i, 7) = mean(SelectedData2(current_indices2, 5));
        AggregatedData(i, 8) = mean(SelectedData2(current_indices2, 6));
        AggregatedData(i, 9) = mean(SelectedData2(current_indices2, 7));
        AggregatedData(i,10) = mean(SelectedData2(current_indices2, 8));
        AggregatedData(i,11) = mean(SelectedData2(current_indices2, 9));
        AggregatedData(i,12) = mean(SelectedData2(current_indices2,10));
        AggregatedData(i,13) = mean(SelectedData2(current_indices2,11));
        AggregatedData(i,14) = mean(SelectedData2(current_indices2,12));
        AggregatedData(i,15) = mean(SelectedData2(current_indices2,13));
        AggregatedData(i,16) = mean(SelectedData2(current_indices2,14));
        AggregatedData(i,17) =  max(SelectedData2(current_indices2,15));
    end
    ...
    graphobj1.print     = 'yes';
    graphobj1.close     = 'no';
    Fig1 = PlotCurve1(epi_dates,AggregatedData(:,3)/1000,graphobj1);
    % ..........................................................
    ...
    graphobj2.print      = 'yes';
    graphobj2.close      = 'no';
    Fig2 = PlotEnvelope1(epi_dates,AggregatedData(:,4),...
                                   AggregatedData(:,5),...
                                   AggregatedData(:,6),graphobj2);
    % ..........................................................
    ...
    graphobj3.print        = 'yes';
    graphobj3.close        = 'no';
    Fig3 = PlotEnvelope1(epi_dates,AggregatedData(:,7),...
                                   AggregatedData(:,8),...
