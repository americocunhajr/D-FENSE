...
(M1 <- TSA::arima(window(DengueSprint2025_AggregatedData_RJ_ts[,"ln100_casos"],,
                  ...
                  order = c(2,0,0)
                  , seasonal = list(order = c(1,1, 0))#,io=out_m1$ind
                  ,xreg = cbind(window(DengueSprint2025_AggregatedData_RJ_ts[,"temp_med"],
                                       start=c(2010,52),
                                       end = c(2021,23)),
                                ts(rollsumr(DengueSprint2025_AggregatedData_RJ_ts[,"precip_med"],k=52)/52,
...
write.csv(saida_T1_csv[16:67,], 
          "~/UERJ/Extens?o/EstatisticaSemFronteiras/Dengue_2025/DengueSprint2025_DataAggregated/T1_arimax_RJ.csv")
...
write.csv(saida_T2_csv[16:67,], 
          "~/UERJ/Extens?o/EstatisticaSemFronteiras/Dengue_2025/DengueSprint2025_DataAggregated/T2_arimax_RJ.csv")
...
write.csv(saida_T3_csv[16:67,], 
          "~/UERJ/Extens?o/EstatisticaSemFronteiras/Dengue_2025/DengueSprint2025_DataAggregated/T3_arimax_RJ.csv")
